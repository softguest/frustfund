...
//     labels,
//     datasets: [
//       { label: 'Deposits', data: [], backgroundColor: '#970e0eff', borderRadius: 6 },
//       { label: 'Transfers', data: [], backgroundColor: '#d12222ff', borderRadius: 6 },
...
//         labels,
//         datasets: [
//           { label: 'Deposits', data: deposits, backgroundColor: '#970e0eff', borderRadius: 6 },
//           { label: 'Transfers', data: transfers, backgroundColor: '#d12222ff', borderRadius: 6 },
...
//     scales: {
//       x: {
//         ticks: { color: '#970e0eff', font: { size: 10 } },
//         grid: { color: '#e5e7eb' },
//         stacked: false,
//       },
//       y: {
